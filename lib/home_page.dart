        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                _buildNavItem(0, Icons.auto_stories_outlined, Icons.auto_stories, 'ذكرياتي'),
                _buildNavItem(1, Icons.photo_camera_outlined, Icons.photo_camera, 'استديو'),
                _buildMenuButton(),
              ],
            ),
          ),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            Text('القائمة', style: TextStyle(fontFamily: 'Tajawal', color: starWhite.withOpacity(0.5), fontSize: 12)),
          ],
        ),
      ),
    );
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const Text('قائمة الذكريات', style: TextStyle(fontFamily: 'Tajawal', fontSize: 20, fontWeight: FontWeight.bold, color: starWhite)),
