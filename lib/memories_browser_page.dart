    ...
    return showDialog<String>(
      ...
      builder: (ctx) {
        return AlertDialog(
          ...
          title: const Text('حفظ الذكرى', textAlign: TextAlign.center, style: TextStyle(color: starWhite, fontSize: 20, fontWeight: FontWeight.bold)),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              const Text('هل تريد إضافة عنوان للذكرى؟', textAlign: TextAlign.center, style: TextStyle(color: starWhite, fontSize: 16)),
              const SizedBox(height: 16),
              Container(
                decoration: BoxDecoration(color: textFieldGray, borderRadius: BorderRadius.circular(12)),
                child: TextField(controller: titleController, textAlign: TextAlign.right, textDirection: TextDirection.rtl, style: const TextStyle(color: Colors.black, fontSize: 16), decoration: InputDecoration(hintText: 'عنوان الذكرى (اختياري)', hintStyle: TextStyle(color: lightGray), border: InputBorder.none, contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12))),
              ),
            ],
          ),
          actionsAlignment: MainAxisAlignment.spaceEvenly,
          actions: [
            TextButton(onPressed: () => Navigator.pop(ctx, null), child: const Text('إلغاء', style: TextStyle(color: Colors.red, fontSize: 16))),
            TextButton(onPressed: () => Navigator.pop(ctx, ''), child: const Text('بدون عنوان', style: TextStyle(color: starWhite, fontSize: 16))),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          const Text('فضاء الذكريات', style: TextStyle(fontFamily: 'Tajawal', fontSize: 26, fontWeight: FontWeight.bold, color: starWhite, letterSpacing: 2)),
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(hintText: 'اكتب ذكرياتك هنا...', hintStyle: TextStyle(color: lightGray, fontFamily: 'Tajawal'), border: InputBorder.none, contentPadding: const EdgeInsets.all(20), filled: true, fillColor: textFieldGray),
        ),
      ),
    );
  }
